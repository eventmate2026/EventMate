    ...
    <>
      ...
      {isOrganizer && (
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="flex items-center justify-between gap-2 h-16 sm:h-[72px] sm:gap-3">
          ...
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            >
              <span className="relative font-extrabold text-[1.55rem] leading-none tracking-[-0.03em] min-[390px]:text-[1.75rem] sm:text-2xl">
