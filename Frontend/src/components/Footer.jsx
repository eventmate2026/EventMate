...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 text-center sm:text-left">
        <motion.div variants={reveal} transition={{ delay: prefersReducedMotion ? 0 : 0.03 }}>
          ...
          <p className="mt-3 text-sm text-gray-600 dark:text-slate-300 max-w-sm mx-auto sm:mx-0">
      ...
      <div className="border-t border-gray-300/80 dark:border-indigo-300/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col items-center sm:flex-row sm:items-center justify-between gap-3 text-sm text-gray-600 dark:text-slate-300 text-center">
