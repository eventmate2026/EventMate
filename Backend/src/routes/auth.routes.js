...
router.post("/resend-verification-otp", otpRequestLimiter, resendVerificationOtpController);
router.post("/verify-email", otpVerificationLimiter, verifyEmailController);
